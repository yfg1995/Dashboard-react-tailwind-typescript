...
export const NotificationCounter: FC<INotificationCounter> = ({
  ...
  return (
    <div
      className={cn(
        "absolute top-1/2 -translate-y-1/2 lg:top-1/2 right-[15px] lg:left-[87%] font-medium flex bg-brandBlue w-5 h-5 items-center justify-center p-0.5 rounded-full mr-2 text-white text-xs lg:text-sm",
        className,
