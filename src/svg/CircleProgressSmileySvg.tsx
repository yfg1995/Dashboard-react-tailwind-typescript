...
export interface ICircleProgressSmileySvg {}

export const CircleProgressSmileySvg = forwardRef<
  SVGSVGElement,
  ICircleProgressSmileySvg
>((props, ref) => {
  return (
    <svg
      {...props}
        ...
        >
          <g id="layer1" transform="translate(-95.557772,-138.94194)">
            ...
            >
              ...
              />
              <path
                d="m 328.933,290 c -2.398,0 -4.341,-1.944 -4.341,-4.341 v -3.473 c 0,-2.398 1.943,-4.342 4.341,-4.342 2.397,0 4.341,1.944 4.341,4.342v3.473c0,2.397-1.944,4.341-4.341,4.341z"
                fill="#7d5046"
                id="path5"
              />
              <path
                d="m 328.933,277.844 c -0.298,0 -0.588,0.031 -0.869,0.088v5.99c0,1.439 1.167,2.605 2.605,2.605 1.439,0 2.605,-1.166 2.605,-2.605v-1.736c0,-2.398 -1.943,-4.342 -4.341,-4.342z"
                fill="#9c6846"
                id="path6"
              />
              <path
                d="m 365.401,290 c -2.398,0 -4.342,-1.944 -4.342,-4.341 v -3.473 c 0,-2.398 1.944,-4.342 4.342,-4.342 2.397,0 4.341,1.944 4.341,4.342v3.473c0,2.397-1.944,4.341-4.341,4.341z"
                fill="#7d5046"
                id="path7"
              />
              <path
                d="m 365.401,277.844 c -0.298,0 -0.588,0.031 -0.869,0.088v5.99c0,1.439 1.167,2.605 2.605,2.605 1.439,0 2.605,-1.166 2.605,-2.605v-1.736c0,-2.398 -1.944,-4.342 -4.341,-4.342z"
                fill="#9c6846"
                id="path8"
              />
              <path
                d="m 354.981,336.019c-29.731,0-53.833,-24.102-53.833,-53.833 0,-12.876 4.525,-24.69 12.065,-33.954-12.128,9.871-19.88,24.912-19.88,41.768 0,29.731 24.102,53.833 53.834,53.833 16.856,0 31.897,-7.752 41.768,-19.88-9.264,7.54-21.078,12.066-33.954,12.066z"
                fill="#ffd164"
                id="path9"
              />
            </g>
